...
// ================= STATUS ================= function isPinSystemReady() {
return !!( window.PIN_SYSTEM_STATE && window.PIN_SYSTEM_STATE.initialized === true ); }
// ================= EXPORT ================= window.startPinSystem = startPinSystem; window.isPinSystemReady = isPinSystemReady;
console.log("[PIN SYSTEM INITIALIZER] READY ✔");
